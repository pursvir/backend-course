...
def room_ids_for_booking(
    ...
    if hotel_id is not None:
        room_ids_from_hotel = room_ids_from_hotel.filter_by(hotel_id=hotel_id)
    room_ids_from_hotel_subq: Subquery = room_ids_from_hotel.subquery(name="room_ids_from_hotel")
    query = (
